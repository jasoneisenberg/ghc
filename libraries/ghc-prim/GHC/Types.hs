...
-- and unlifted ones (that don't). Certain operations need
...
-- @TYPE ('PtrRep 'Lifted)@ and unlifted (but boxed) ones have kind
-- @TYPE ('PtrRep 'Unlifted)@.
data Levity = Lifted
            | Unlifted
