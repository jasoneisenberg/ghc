...
-- | If the tyvar is a RuntimeRep var, set it to (PtrRep Lifted). Returns whether or
-- not this happened.
...
default any RuntimeRep variables to (PtrRep Lifted).  This is important
...
the RuntimeRep variable to (PtrRep Lifted), but this seems unnecessarily indirect.
