...
data TcGblEnv
  = TcGblEnv {
        ...
        tcg_th_top_level_locs :: TcRef (Set RealSrcSpan),
          -- ^ Locations of the top-level splices; used for providing TH-related
          -- details in error messages for out-of-scope variables
...
-- Yuk!
trulyInsoluble _tc_lvl insol = not (isHoleCt insol) || isOutOfScopeCt insol
